...
<body><?php include_once('barraNavegacion.php') ?>
...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">AVIONES</h5>
        <a href="agregarAvionSerializable.php" class="btn btn-primary btn btn-raised btn-toolbar btn-lg"  class="">
      <span class=""></span> Nuevo avion</a><br>

      <a href="verAvionesSerializable.php" class="btn btn-primary btn btn-raised btn-toolbar btn-lg" class="">
      <span class=""></span> ver listado de avion</a>
       
    </div>
    <div class="card-footer">
      <small class="text-muted">nivel de aislamiento Serializable</small>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="agregarVueloSerializable.php" class="btn btn-primary btn btn-raised btn-toolbar btn-lg" >
      <span class="fa fa-plus-circle"></span> Nuevo vuelo</a><br>

      <a href="verVueloSerializable.php" class="btn btn-primary btn btn-raised btn-toolbar btn-lg" >
      <span class="fa fa-plus-circle"></span> Ver listado de vuelos</a>

      
    </div>
    <div class="card-footer">
      <small class="text-muted">Nivele de aislamiento Serializable</small>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-footer">
      <small class="text-muted">Ejecutar cualquiera de estas acciones</small>
    </div>
  </div>
