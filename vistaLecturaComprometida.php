...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">AVIONES</h5>
        <a href="agregarAvionLecturaC.php" class="btn btn-primary btn btn-raised btn-toolbar btn-lg"  class="">
      <span class=""></span> Nuevo avion</a><br>

      <a href="verAvionesLecturaC.php" class="btn btn-primary btn btn-raised btn-toolbar btn-lg" class="">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="agregarVueloLecturaC.php" class="btn btn-primary btn btn-raised btn-toolbar btn-lg" >
      <span class="fa fa-plus-circle"></span> Nuevo vuelo</a><br>

      <a href="verVuelosLecturaC.php" class="btn btn-primary btn btn-raised btn-toolbar btn-lg" >
